...
{
    /// <summary>
    /// <see cref="!:https://haveibeenpwned.com/API/v2#BreachesForAccount"/>
    /// </summary>
    public class Breach
    {
        /// <summary>
        ...
        /// (i.e. if another breach occurs against an organization already in the system). I
        /// f a stable value is required to reference the breach, refer to the "Name" attribute instead.
        /// </summary>
        ...
        /// here are changed or data in the breach itself is changed (i.e. additional data is identified and loaded). 
        ...
        /// <summary>
        /// Indicates that the breach is considered fabricated. A fabricated breach is unlikely 
        /// to have been hacked from the indicated website and usually contains a large amount of manufactured data. 
        ...
        /// <summary>
        /// Active within the dataset of the pwened.
        /// </summary>
        ...
        /// <summary>
        /// ndicates if the breach is considered a spam list. 
